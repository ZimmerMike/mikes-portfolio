    ...
    <>
      <main className="container">
        <div className="flex flex-col items-center">
          <div className="flex flex-col items-center backdrop-blur-lg bg-[#0a0a0a]/50 border-4 border-white/5 w-[95%] h-fit p-6 md:p-8 rounded-4xl">
            {/* Card header */}
            ...
            <section className="w-full h-fit">
              <div className={`w-full bg-white/5 rounded-2xl p-4 transition-all duration-300 ${
