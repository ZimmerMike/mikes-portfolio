...
export default function NavbarItem({ href, icon, label }: NavbarItemProps) {
  return (
    <div className="w-full rounded-2xl md:border-2 md:border-white/5 bg-[#0a0a0a] hover:bg-white/5 hover:backdrop-blur-2xl hover:scale-105 transition-transform duration-400">
